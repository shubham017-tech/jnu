      ...
      <section className="w-full h-screen max-md:h-auto text-white py-10 px-6 mb-6">
        <div className="container max-md:w-full max-md:mx-1 h-screen max-md:h-[100%] flex flex-col items-center">
          <div className="w-[90%] max-md:h-[90%] h-screen max-lg:w-screen max-md:w-full max-md:mt-44 flex flex-col items-center mt-36 space-y-6 text-center">
            ...
            <div className="flex hero-section-image relative border max-md:w-screen max-md:hidden max-md:h-48 h-[450px] overflow-hidden outline-none border-gray-600 w-[95%] justify-center items-start rounded-t-2xl shadow-2xl mt-8 bg-slate-900/40">
              <img
                className="dashboard w-full h-full z-40 object-cover object-center scale-110 transition-transform duration-700 hover:scale-[1.15]"
                src="/images/dashboard.png"
                alt="Jaipur National University Dashboard Overview"
              />
            </div>
          </div>
        </div>
